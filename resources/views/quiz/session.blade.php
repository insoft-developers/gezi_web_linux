 ...
 <div class="content-wrapper">
   ...
   <section class="content-header">
     <h1>
       Kompetensi Dasar Implementation
     ...
     <ol class="breadcrumb">
       ...
       <li class="active">Kompetensi Dasar Implementation</li>
     </ol>
   </section>
       ...
       <div class="col-xs-12">
         ...
         <div class="box">
           <div class="box-header">
             <h3 class="box-title">Kompetensi Dasar Implementation </h3>
           ...
           <div class="box-body" style="margin-top:10px">
             ...
             <div class="table-responsive">
               <table style="font-size:12px;" id="sessquiz_table" class="table table-bordered table-striped nowrap">
                 <thead>
                   <tr>
                     <th width="5%">ID</th>
